...
public class Odometer implements Runnable {
  ...
  private volatile double leftWheelTotalDist;
  private volatile double rightWheelTotalDist;
  ...
  public void run() {
    ...
    // Initialize the total distances
    leftWheelTotalDist = 0;
    rightWheelTotalDist = 0;
    ...
    while (true) {
      ...
      leftWheelTotalDist += distL;
      rightWheelTotalDist += distR;
  ...
  public double[] getXyt() {
    ...
    try {
      ...
      position[1] = y;
      position[2] = theta;
      position[3] = leftWheelTotalDist;
      position[4] = rightWheelTotalDist;
